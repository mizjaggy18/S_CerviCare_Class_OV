...
RUN mkdir -p /models 
ADD /models/cervicare-2class_dn21adam_best_model_100ep.bin /models/cervicare-2class_dn21adam_best_model_100ep.bin
ADD /models/cervicare-2class_dn21adam_best_model_100ep.xml /models/cervicare-2class_dn21adam_best_model_100ep.xml
RUN chmod 444 /models/cervicare-2class_dn21adam_best_model_100ep.bin
RUN chmod 444 /models/cervicare-2class_dn21adam_best_model_100ep.xml
